...
void setup() {
  ...
  Serial.begin(115200);
  nonBlockingDelay(50, [](){}, lastMillis);  // Non-blocking delay
...
// If you also want to see all traffic on the bus use N2km_ListenAndNode instead of N2km_NodeOnly below
  ...
  NMEA2000.Open();
  nonBlockingDelay(200, [](){}, lastMillis);  // Non-blocking delay
